...
iris = pd.read_csv("E:\Machine learning\dataset\IRIS.csv")
print(iris.head())

x = iris.drop("species", axis=1)
y = iris["species"]
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2, random_state=42)  # Corrected test_size value
